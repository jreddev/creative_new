...
router.post('/', async (req, res) => {
  ...
  // malformed.
  if (!req.body.firstName || !req.body.lastName || !req.body.email || !req.body.address || !req.body.username || !req.body.password)
    return res.status(400).send({
      message: "first name, last name, email, address, username and password are required"
    });

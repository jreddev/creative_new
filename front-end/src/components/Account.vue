...
<div class="accountpage">
  <div class="hero">
    <div class="heroBox">
      ...
      <legend></legend>
        <button class="pure-button pure-button-secondary" @click="setDeleting">Delete your account</button>
        <form class="pure-form2" v-if="isdeleting" @submit.prevent="DeleteAccount">
          <fieldset>
            <p>Are you sure you want to delete your account?</p>
            <button class="pure-button pure-button-secondary" @click="DeleteMyAccount()">Yes</button>
              <button class="pure-button pure-button-secondary" @click="cancelDeleting">No</button>
          </fieldset>
        </form>
